...
class DecreasePipePage extends StatefulWidget {
  const DecreasePipePage({super.key});

  @override
  _DecreasePipePageState createState() => _DecreasePipePageState();
}

class _DecreasePipePageState extends State<DecreasePipePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('صرف مواسير', style: TextStyle(fontSize: 20.sp, color: Colors.white)),
