...
class AddInjectedProductPage extends StatefulWidget {
  const AddInjectedProductPage({super.key});

  @override
  _AddInjectedProductPageState createState() => _AddInjectedProductPageState();
}

class _AddInjectedProductPageState extends State<AddInjectedProductPage> {
  ...
  void _saveData() async {
    ...
    for (var product in _addedProducts) {
      ...
      if (query.docs.isNotEmpty) {
        ...
        DocumentReference newProductRef = await FirebaseFirestore.instance.collection('injectedProducts').add({
